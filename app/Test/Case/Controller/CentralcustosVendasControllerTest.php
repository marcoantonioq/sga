<?php
App::uses('CentralcustosVendasController', 'Controller');

/**
 * CentralcustosVendasController Test Case
 *
 */
class CentralcustosVendasControllerTest extends ControllerTestCase {
