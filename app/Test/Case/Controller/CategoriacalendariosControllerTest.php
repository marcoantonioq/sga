<?php
App::uses('CategoriacalendariosController', 'Controller');

/**
 * CategoriacalendariosController Test Case
 *
 */
class CategoriacalendariosControllerTest extends ControllerTestCase {
