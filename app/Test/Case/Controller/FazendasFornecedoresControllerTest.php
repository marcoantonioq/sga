<?php
App::uses('FazendasFornecedoresController', 'Controller');

/**
 * FazendasFornecedoresController Test Case
 *
 */
class FazendasFornecedoresControllerTest extends ControllerTestCase {
