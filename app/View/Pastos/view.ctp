...
<div class='tabbable'>
    <ul class='nav nav-tabs'>
        <li class='active'>
            <a href='#tabPasto' data-toggle='tab'><?php echo __('Pasto'); ?></a>
        </li>
    </ul>
    <div class='tab-content'>
    	<div class='tab-pane active' id='tabPasto'> 
			<dl>
				<dt><?php echo __('id'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['id']); ?>
                    &nbsp;
                </dd>
                <dt><?php echo __('Retiro'); ?></dt>
                <dd>
                ...
                <dd>
                    <?php echo h($pasto['Pasto']['nome']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('tipo'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['tipo']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('datainclusao'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['datainclusao']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('area'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['area']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('topografia'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['topografia']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('tipoaguado'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['tipoaguado']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('bovino_count'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['bovino_count']); ?>
                    &nbsp;
                </dd>
				<dt><?php echo __('descricao'); ?></dt>
                <dd>
                    <?php echo h($pasto['Pasto']['descricao']); ?>
                    &nbsp;
                </dd>
			</dl>
		</div>
